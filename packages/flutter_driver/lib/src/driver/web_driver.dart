  ...
  Future<Map<String, dynamic>> sendCommand(Command command) async {
    ...
    try {
      ...
      if (decoded is! Map<String, dynamic>) {
        ...
        print('setting response to decoded');
        response = decoded;
      }
      print('here 3');
      ...
      print('rethrowing driver error');
      rethrow;
    } catch (error, stackTrace) {
      print('throwing in next catch');
      throw DriverError(
...
class FlutterWebConnection {
  ...
  static Future<FlutterWebConnection> connect(
    ...
    final async_io.WebDriver driver = async_io.WebDriver(
        ...
        async_io.AsyncIoRequestClient(
            sessionUri.resolve('session/$sessionId/')),
  ...
  Future<dynamic> sendCommand(String script, Duration? duration) async {
    ...
    try {
      print('before _driver.execute');
      await _driver.execute(r'return $flutterDriverResult', <String>[]);
      print('after _driver.execute');
    } catch (error, stackTrace) {
      print('catching and throwing');
      throw DriverError(
    ...
    try {
      print('before _driver.execute 2');
      ...
      print('resetting, result now = $result');
